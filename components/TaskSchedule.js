...
import { StyleSheet, Text, View, TextInput, FlatList, Image, TouchableOpacity, Platform, Alert } from 'react-native';
...
const TaskSchedule = () => {
    ...
    const handleAssignSchedule = async () => {
        ...
        try {
            ...
            Alert.alert('Success', response.data.message || 'Schedule assigned successfully');
    ...
    return (
        <View style={styles.container}>
            <Text style={{ color: '#376ADA', fontSize: 20, fontWeight: '600', marginVertical: 10 }}>
                Task Schedule
            </Text>
            ...
            <View style={styles.bottomSection}>
                <View style={styles.buttonContainer}>
                    <TouchableOpacity onPress={handleAssignSchedule}>
                        <Text style={{ color: '#fff', textAlign: 'center', backgroundColor: '#376ADA', padding: 10, borderRadius: 7, fontSize: 14, fontWeight: '500' }}>
                            Assign Schedule
                        </Text>
                    </TouchableOpacity>
                </View>
